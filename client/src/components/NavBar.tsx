...
const NavBar = ({ isPremium }: NavBarProps) => {
  return (
    <div className="fixed bottom-0 left-0 right-0 h-16 bg-black/80 backdrop-blur-md border-t border-rulet-purple/20 flex justify-around items-center px-4 z-20">
      <Link to="/chat" className="nav-button active">
      ...
      {isPremium ? (
        <Link to="/premium" className="nav-button text-yellow-500">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mb-1">
